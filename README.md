[README.md](https://github.com/user-attachments/files/31614759/README.md)
...
|---|---|---|
| SAST | Semgrep | Identify security issues in source code |
...
| Containerization | Docker | Build the application container |
...
| CI/CD Automation | GitHub Actions | Automate security validation |
| Container Registry | GitHub Container Registry | Store container images |
